...
# pos_file = os.path.join(topic_path, "test_pos.csv")
# neg_file = os.path.join(topic_path, "test_neg.csv")
...
# ngram level tf-idf
tfidf_vect_ngram = TfidfVectorizer(analyzer='word', token_pattern=r'\w{1,}', ngram_range=(9,9), max_features=5000)
